...
const matriculaSchema = new mongoose.Schema({
  ...
  // Padre/madre/encargado responsable del alumno — se vincula en el momento
  // de matricular, que es el punto natural donde se formaliza esa relación.
  padre:          { type: mongoose.Schema.Types.ObjectId, ref: 'Padre', default: null },
